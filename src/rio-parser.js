...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c150 = "export",
      peg$c151 = peg$literalExpectation("export", false),
      peg$c152 = "false",
      ...
      peg$c189 = function(elision) {
            return {
              type: "ArrayExpression",
              elements: optionalList(extractOptional(elision, 0))
            };
          },
      peg$c190 = function(elements) {
            return {
              type: "ArrayExpression",
              elements: elements
            };
      ...
      peg$c193 = function(elements, elision) {
            return {
              type: "ArrayExpression",
              elements: elements.concat(optionalList(extractOptional(elision, 0)))
            };
          },
      peg$c194 = function(elision, element) {
              return optionalList(extractOptional(elision, 0)).concat(element);
            },
      peg$c195 = function(head, elision, element) {
              return optionalList(extractOptional(elision, 0)).concat(element);
            },
      peg$c196 = function(head, tail) { return Array.prototype.concat.apply(head, tail); },
      peg$c197 = function(commas) { return filledArray(commas.length + 1, null); },
      peg$c198 = "{",
      peg$c199 = peg$literalExpectation("{", false),
      peg$c200 = function() { return { type: "ObjectExpression", properties: [] }; },
      peg$c201 = function(properties) {
      ...
      peg$c210 = function(e) { return e },
      peg$c211 = function(args) {
      ...
      peg$c225 = function(head, tail) { return buildBinaryExpression(head, tail); },
      peg$c226 = "*",
      ...
      peg$c262 = function(head, tail) { return buildLogicalExpression(head, tail); },
      peg$c263 = "&&",
      ...
      peg$c271 = function(head, snd, tail) {
          return {
              type: "CallExpression",
              callee: {
                type: "Identifier",
      ...
      peg$c272 = function(m) { return m },
      peg$c273 = "?",
      peg$c274 = peg$literalExpectation("?", false),
      peg$c275 = function(test, consequent, alternate) {
            return {
      ...
      peg$c278 = function(head, tail) { return buildList(head, tail, 1); },
      peg$c279 = function() { return { type: "EmptyStatement" }; },
      peg$c280 = function(declaration) {
            return {
      ...
      peg$c281 = function(expression) {
            return {
              type: "ExpressionStatement",
              expression: expression
            };
          },
      peg$c282 = function(test, consequent, alternate) {
            return {
              type: "IfStatement",
              test: test,
              consequent: consequent,
      ...
      peg$c283 = function(test, consequent) {
            return {
              type: "IfStatement",
              test: test,
              consequent: consequent,
      ...
      peg$c288 = function(discriminant, cases) {
            return {
      ...
      peg$c296 = function(url, head, tail) {
      	return {
      ...
      peg$c297 = function(url, head, tail) {
      	return {
      		type: "ImportDeclaration",
      		source: url,
      		specifiers: buildList(head, tail, 3)
      ...
      peg$c299 = "as",
      peg$c300 = peg$literalExpectation("as", false),
      peg$c301 = function(id, name) {
      	return {
      ...
      peg$c304 = function(body) { return body; },
      ...
      peg$c306 = function(body) {
            return {
              type: "BlockStatement",
              body: [{type: "ReturnStatement", argument: body}]
            };
          },
      peg$c307 = function(body) {
            return {
              type: "Program",
              body: optionalList(body)
            };
  ...
  function peg$parseStrictCallExpression() {
    var s0, s1, s2, s3;
  ...
  function peg$parseMemberInCompositionExpression() {
    var s0, s1;
  ...
  function peg$parseCallInCompositionExpression() {
    var s0, s1, s2, s3;

    s0 = peg$currPos;
    s1 = peg$parseMemberInCompositionExpression();
    if (s1 !== peg$FAILED) {
      s2 = peg$parse__();
      if (s2 !== peg$FAILED) {
        s3 = peg$parseArguments();
  ...
  function peg$parseCallInPromiseCompositionExpression() {
    var s0, s1, s2, s3;
  ...
  function peg$parsePromiseArguments() {
    var s0, s1, s2, s3, s4, s5;
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        s3 = peg$currPos;
        s4 = peg$parsePromiseArgumentList();
        if (s4 !== peg$FAILED) {
          s5 = peg$parse__();
          if (s5 !== peg$FAILED) {
            s4 = [s4, s5];
  ...
  function peg$parsePromiseArgumentList() {
    var s0, s1, s2, s3, s4, s5, s6, s7;

    s0 = peg$currPos;
    s1 = peg$parseInPromiseExpression();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parse__();
      if (s4 !== peg$FAILED) {
        ...
        if (s5 !== peg$FAILED) {
          s6 = peg$parse__();
          if (s6 !== peg$FAILED) {
            s7 = peg$parseInPromiseExpression();
            if (s7 !== peg$FAILED) {
              s4 = [s4, s5, s6, s7];
              s3 = s4;
            } else {
  ...
  function peg$parseCallInMonadCompositionExpression() {
    var s0, s1, s2, s3;
  ...
  function peg$parseMonadArguments() {
    var s0, s1, s2, s3, s4, s5;
  ...
  function peg$parseMonadArgumentList() {
    var s0, s1, s2, s3, s4, s5, s6, s7;

    s0 = peg$currPos;
    s1 = peg$parseInMonadExpression();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parse__();
  ...
  function peg$parseExpression() {
    ...
    s0 = peg$parseSpecialFunctionExpression();
    if (s0 === peg$FAILED) {
      s0 = peg$parseFunctionCompositionExpression();
      if (s0 === peg$FAILED) {
        s0 = peg$parsePromiseCompositionExpression();
        if (s0 === peg$FAILED) {
          s0 = peg$parseMonadCompositionExpression();
          if (s0 === peg$FAILED) {
            s0 = peg$parseCallExpression();
            if (s0 === peg$FAILED) {
  ...
  function peg$parseInPromiseExpression() {
    var s0;
  ...
  function peg$parseInMonadExpression() {
    var s0;
  ...
  function peg$parseSpecialFunctionExpression() {
    var s0;

    s0 = peg$parseSingleArgumentFunctionExpression();
    if (s0 === peg$FAILED) {
      s0 = peg$parseEmptyArgumentFunctionExpression();
    }

    return s0;
  }

  function peg$parseEmptyArgumentFunctionExpression() {
    var s0, s1, s2, s3, s4, s5;
  ...
  function peg$parseSingleArgumentFunctionExpression() {
    var s0, s1, s2, s3;
  ...
  function peg$parsePromiseCompositionExpression() {
    ...
    s0 = peg$currPos;
    s1 = peg$parsePromiseCompositionMember();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parse__();
      if (s4 !== peg$FAILED) {
        s5 = peg$parseThenCall();
        if (s5 !== peg$FAILED) {
          s6 = peg$parse__();
          if (s6 !== peg$FAILED) {
            s7 = peg$parsePromiseCompositionMember();
            if (s7 !== peg$FAILED) {
              s4 = [s4, s5, s6, s7];
              s3 = s4;
            } else {
  ...
  function peg$parsePromiseCompositionMember() {
    var s0;

    s0 = peg$parseBracketCompositionMember();
    if (s0 === peg$FAILED) {
      s0 = peg$parseCallInPromiseCompositionExpression();
      if (s0 === peg$FAILED) {
        s0 = peg$parseIdentifier();
      }
    }
  ...
  function peg$parseMonadCompositionExpression() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseMonadCompositionMember();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parse__();
      if (s4 !== peg$FAILED) {
        s5 = peg$parseBindToken();
        if (s5 !== peg$FAILED) {
          s6 = peg$parse__();
          if (s6 !== peg$FAILED) {
            s7 = peg$parseMonadCompositionMember();
            if (s7 !== peg$FAILED) {
              s4 = [s4, s5, s6, s7];
              s3 = s4;
            } else {
  ...
  function peg$parseMonadCompositionMember() {
    var s0;

    s0 = peg$parseBracketCompositionMember();
    if (s0 === peg$FAILED) {
      s0 = peg$parseCallInMonadCompositionExpression();
      if (s0 === peg$FAILED) {
        s0 = peg$parseIdentifier();
      }
    }
            ...
            if (s5 !== peg$FAILED) {
              ...
              if (s8 !== peg$FAILED) {
                ...
                if (s9 !== peg$FAILED) {
                  s10 = peg$parse__();
                  if (s10 !== peg$FAILED) {
                    s11 = peg$parseCompositionMember();
                    if (s11 !== peg$FAILED) {
                      s8 = [s8, s9, s10, s11];
                      s7 = s8;
                    } else {
  ...
  function peg$parseCompositionMember() {
    var s0;

    s0 = peg$parseBracketCompositionMember();
    if (s0 === peg$FAILED) {
      s0 = peg$parseCallInCompositionExpression();
      if (s0 === peg$FAILED) {
        s0 = peg$parseIdentifier();
      }
    }
  ...
  function peg$parseBracketCompositionMember() {
    var s0, s1, s2, s3, s4, s5;
  ...
  function peg$parseConditionalExpressionOnly() {
    var s0, s1, s2, s3, s4, s5, s6, s7, s8, s9;
  ...
  function peg$parseReturnStatement() {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parse_();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseConditionalExpressionOnly();
          if (s3 === peg$FAILED) {
            s3 = peg$parseExpression();
          }
          if (s3 !== peg$FAILED) {
  ...
  function peg$parseFunctionBody() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseArrowToken();
    if (s1 !== peg$FAILED) {
      s2 = peg$parse__();
      if (s2 !== peg$FAILED) {
        s3 = peg$parseFunctionBlockBody();
        if (s3 !== peg$FAILED) {
          peg$savedPos = s0;
          s1 = peg$c304(s3);
          s0 = s1;
  ...
  function peg$parseFunctionBlockBody() {
    var s0, s1, s2, s3, s4, s5;
  ...
  function peg$parseFunctionOneLiner() {
    var s0, s1, s2;
    ...
    if (s1 !== peg$FAILED) {
      s2 = peg$parseConditionalExpressionOnly();
      if (s2 === peg$FAILED) {
        s2 = peg$parseExpression();
      }
      if (s2 !== peg$FAILED) {
