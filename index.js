...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c164 = "switch",
      peg$c165 = peg$literalExpectation("switch", false),
      peg$c166 = "true",
      ...
      peg$c176 = function(elements, elision) {
            return {
              type: "ArrayExpression",
              elements: elements.concat(optionalList(extractOptional(elision, 0)))
            };
          },
      peg$c177 = function(elision, element) {
              return optionalList(extractOptional(elision, 0)).concat(element);
            },
      peg$c178 = function(head, elision, element) {
              return optionalList(extractOptional(elision, 0)).concat(element);
            },
      peg$c179 = function(head, tail) { return Array.prototype.concat.apply(head, tail); },
      peg$c180 = function(commas) { return filledArray(commas.length + 1, null); },
      peg$c181 = "{",
      peg$c182 = peg$literalExpectation("{", false),
      peg$c183 = function() { return { type: "ObjectExpression", properties: [] }; },
      peg$c184 = function(properties) {
      ...
      peg$c189 = function(id) { return [id]; },
      peg$c190 = function(e) { return e },
      peg$c191 = function(callee, args) {
      ...
      peg$c196 = function(args) {
            return optionalList(extractOptional(args, 0));
          },
      peg$c197 = function(operator, argument) {
            return {
      ...
      peg$c210 = function(head, tail) { return buildBinaryExpression(head, tail); },
      peg$c211 = "*",
      ...
      peg$c249 = function(head, tail) { return buildLogicalExpression(head, tail); },
      peg$c250 = "&&",
      ...
      peg$c256 = "io",
      peg$c257 = peg$literalExpectation("io", false),
      peg$c258 = "{{",
      ...
      peg$c263 = function(callee, snd, tail) {
          return {
              type: "CallExpression",
              callee: callee, arguments: [buildComposition(snd, flattenList(tail,3))]
          };
        },
      peg$c264 = function(m) { return m },
      peg$c265 = "?",
      peg$c266 = peg$literalExpectation("?", false),
      peg$c267 = function(test, consequent, alternate) {
            return {
      ...
      peg$c271 = function(head, tail) { return buildList(head, tail, 1); },
      peg$c272 = function() { return { type: "EmptyStatement" }; },
      peg$c273 = function(declaration) {
            return {
      ...
      peg$c276 = function(test, consequent) {
            return {
              type: "IfStatement",
              test: test,
              consequent: consequent,
      ...
      peg$c278 = function(label) {
            return { type: "BreakStatement", label: label };
          },
      peg$c279 = function() {
            return { type: "ReturnStatement", argument: null };
          },
      peg$c280 = function(argument) {
      ...
      peg$c287 = function(body) { return body; },
      ...
      peg$c289 = function(body) {
            return {
              type: "BlockStatement",
              body: [{type: "ReturnStatement", argument: body}]
            };
          },
      peg$c290 = function(body) {
            return {
              type: "Program",
              body: optionalList(body)
            };
  ...
  function peg$parseBareExpression() {
    var s0;

    s0 = peg$parseSpecialFunctionExpression();
    if (s0 === peg$FAILED) {
      s0 = peg$parseIoExpression();
      if (s0 === peg$FAILED) {
  ...
  function peg$parseIoExpression() {
